...
Terminal shows [electron] Starting Maker desktop app...
Terminal shows [server] serving on port 5000
Electron window opens
Dashboard loads immediately without a login screen (local auto-login)
Basic Checks
...
Add an RSS source (e.g., https://news.ycombinator.com/rss)
Click "Run Now" on the bot detail page
Confirm a Fast Report is generated within 2–3 seconds
Verify SQLite File
...
Distribution channel setup (GitHub Releases)
Need Help?
