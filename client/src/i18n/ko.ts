export const ko: Record<string, string> = {
  ...
  "landing.hero.title1": "매일 아침, AI가 시장을",
  "landing.hero.title2": "브리핑해 드립니다",
  "landing.hero.subtitle": "경쟁사 동향, 업계 뉴스, 원자재 가격, 규제 변화 — GPT-4o가 매일 아침 핵심만 요약해서 슬랙·이메일로 보내드립니다.",
  "landing.hero.getStarted": "무료 체험 시작",
  "landing.hero.badge1": "GPT-4o 기반 분석",
  "landing.hero.badge2": "매일 자동 브리핑",
  "landing.hero.badge3": "슬랙·이메일 연동",
  "landing.hero.chooseSources": "정보 소스 설정",
  "landing.hero.chooseSourcesDesc": "경쟁사 뉴스, 업계 동향, 원자재 시세, 규제 정보 등 필요한 소스를 연결하세요",
  "landing.hero.scheduleFormat": "브리핑 시간 & 형식",
  "landing.hero.scheduleFormatDesc": "매일 아침 출근 전, 원하는 시간에 맞춤 브리핑을 받으세요",
  "landing.hero.aiAnalysis": "GPT-4o 인사이트",
  "landing.hero.aiAnalysisDesc": "OpenAI GPT-4o가 수집된 정보를 분석하고, 핵심 인사이트와 액션 아이템을 도출합니다.",
  "landing.howItWorks.title": "3단계로 시작하세요",
  "landing.howItWorks.subtitle": "복잡한 설정 없이, 5분이면 매일 아침 시장 브리핑을 받을 수 있습니다.",
  "landing.howItWorks.step1Title": "관심 기업·업종 설정",
  "landing.howItWorks.step1Desc": "경쟁사, 관심 업종, 모니터링할 키워드를 설정하세요. 템플릿으로 빠르게 시작할 수 있습니다.",
  "landing.howItWorks.step2Title": "정보 소스 연결",
  "landing.howItWorks.step2Desc": "뉴스, RSS, 업계 커뮤니티, 정부 공시 등 원하는 정보 소스를 자유롭게 추가하세요.",
  "landing.howItWorks.step3Title": "매일 브리핑 수신",
  "landing.howItWorks.step3Desc": "GPT-4o가 수집된 정보를 분석하고, 매일 아침 슬랙·이메일로 핵심 요약 브리핑을 보내드립니다.",
  "landing.useCases.title": "이런 분들이 사용합니다",
  "landing.useCases.subtitle": "한국 중소기업 실무자들이 매일 활용하는 시장 인텔리전스 시나리오입니다.",
  "landing.faq.title": "자주 묻는 질문",
  "landing.faq.subtitle": "Maker와 사용 방법에 대한 일반적인 질문입니다.",
  "landing.pricing.title": "합리적인 가격",
  "landing.pricing.subtitle": "중소기업의 규모에 맞는 플랜을 선택하세요.",
  "landing.pricing.web.name": "Basic",
  "landing.pricing.web.price": "월 49,000원",
  "landing.pricing.web.desc": "소규모 기업을 위한 시장 인텔리전스",
  "landing.pricing.web.f1": "경쟁사 3개 모니터링",
  "landing.pricing.web.f2": "일일 시장 브리핑",
  "landing.pricing.web.f3": "이메일 리포트",
  "landing.pricing.web.f4": "GPT-4o 분석",
  "landing.pricing.web.button": "무료 체험 시작",
  "landing.pricing.local.name": "Pro",
  "landing.pricing.local.price": "월 99,000원",
  "landing.pricing.local.desc": "성장하는 기업을 위한 풀 패키지",
  "landing.pricing.local.f1": "경쟁사 10개 모니터링",
  "landing.pricing.local.f2": "실시간 알림 (슬랙·텔레그램)",
  "landing.pricing.local.f3": "SWOT 분석 & 트렌드 리포트",
  "landing.pricing.local.button": "무료 체험 시작",
  "landing.pricing.desktop.name": "Desktop",
  "landing.pricing.desktop.price": "Free",
  "landing.pricing.desktop.desc": "로컬 환경에서 직접 운영하는 자동화",
  "landing.pricing.desktop.f1": "오프라인 사용 가능",
  "landing.pricing.desktop.f2": "데이터 100% 로컬 저장",
  "landing.pricing.desktop.f3": "Mac · Windows · Linux",
  "landing.pricing.desktop.f4": "오픈소스 (GitHub)",
  "landing.pricing.desktop.button": "다운로드",
  "landing.pricing.teams.name": "Enterprise",
  "landing.pricing.teams.price": "맞춤 견적",
  "landing.pricing.teams.desc": "대기업·그룹사를 위한 맞춤형",
  "landing.pricing.teams.f1": "무제한 모니터링",
  "landing.pricing.teams.f2": "온프레미스 설치",
  "landing.pricing.teams.f3": "전담 지원 & SLA",
  ...
  "landing.philosophy.line1": "리서치에 쓰는 시간을 줄이고,",
  "landing.philosophy.line2": "의사결정에 집중하세요.",
  ...
  "landing.useCase.researchPaperTracker": "규제·정책 모니터링",
  "landing.useCase.researchPaperTrackerDesc": "정부 공시, 업종별 규제 변화, 보조금·지원사업 공고를 자동으로 추적합니다. 놓치면 안 되는 정보를 놓치지 마세요.",
  "landing.useCase.competitorSignalMonitor": "경쟁사 모니터링",
  "landing.useCase.competitorSignalMonitorDesc": "경쟁사의 제품 출시, 채용 공고, 언론 보도, SNS 반응을 실시간 추적합니다. 변화가 감지되면 즉시 알림.",
  "landing.useCase.communityResearch": "수출·해외시장 동향",
  "landing.useCase.communityResearchDesc": "수출 대상국의 시장 동향, 관세 변화, 바이어 트렌드를 모니터링합니다. 해외 진출 전략에 필요한 인사이트를 제공합니다.",
  "landing.useCase.contentIdeas": "채용·인재 시장 동향",
  "landing.useCase.contentIdeasDesc": "업계 채용 트렌드, 경쟁사 채용 공고, 인재 시장 동향을 추적합니다. HR 전략 수립에 활용하세요.",
  "landing.useCase.workProductivity": "투자·자금조달 정보",
  "landing.useCase.workProductivityDesc": "VC 투자 동향, 정책자금, 신용보증 정보를 매일 추적합니다. 자금 조달 기회를 놓치지 마세요.",
  "landing.useCase.onlineBusiness": "업계 트렌드 리서치",
  "landing.useCase.onlineBusinessDesc": "우리 업계의 기술 트렌드, 소비자 행동 변화, 신제품 출시 동향을 GPT-4o가 분석하고 인사이트를 제공합니다.",
  "landing.useCase.koreaMarketplace": "고객·시장 반응 추적",
  "landing.useCase.koreaMarketplaceDesc": "온라인 커뮤니티, SNS, 리뷰 사이트에서 우리 브랜드와 경쟁사에 대한 고객 반응을 실시간 모니터링합니다.",
  "landing.useCase.websitePromotion": "원자재·공급망 추적",
  "landing.useCase.websitePromotionDesc": "원자재 가격 변동, 공급망 이슈, 환율 동향을 매일 추적합니다. 구매 타이밍 판단에 필요한 정보를 GPT-4o가 요약합니다.",
  "landing.useCase.chatControl": "텔레그램·슬랙 명령",
  "landing.useCase.chatControlDesc": "텔레그램이나 슬랙에서 '오늘 브리핑'이라고 입력하면 즉시 최신 분석 결과를 받아볼 수 있습니다.",
  "landing.useCase.byoLlm": "AI 모델 선택",
  "landing.useCase.byoLlmDesc": "OpenAI GPT-4o를 기본으로, 필요시 다른 AI 모델도 연결 가능합니다. 분석 품질을 직접 비교하세요.",

  "landing.faq.q1": "무료 체험은 어떻게 하나요?",
  "landing.faq.a1": "가입 후 14일간 모든 기능을 무료로 이용할 수 있습니다. 신용카드 등록 없이 바로 시작하세요.",
  "landing.faq.q2": "어떤 정보를 모니터링할 수 있나요?",
  "landing.faq.a2": "뉴스, RSS 피드, 정부 공시, 커뮤니티, SNS 등 다양한 소스를 지원합니다. 커스텀 RSS도 추가 가능합니다.",
  "landing.faq.q3": "GPT-4o가 어떻게 분석하나요?",
  "landing.faq.a3": "OpenAI의 GPT-4o 모델이 수집된 데이터를 분석하여 핵심 요약, SWOT 분석, 트렌드 인사이트를 생성합니다. 단순 요약이 아닌 실행 가능한 액션 아이템을 제안합니다.",
  "landing.faq.q4": "데이터는 안전한가요?",
  "landing.faq.a4": "네. 기업 데이터는 암호화되어 안전하게 관리됩니다. 로컬 설치 모드를 선택하면 모든 데이터가 사내 서버에만 저장됩니다.",
  "landing.faq.q5": "슬랙이나 이메일로 받을 수 있나요?",
  "landing.faq.a5": "네. 텔레그램, 슬랙 연동을 지원하며, 이메일 배송 기능도 준비 중입니다. 매일 아침 원하는 시간에 브리핑을 받을 수 있습니다.",
  "landing.faq.q6": "한국어를 지원하나요?",
  "landing.faq.a6": "네. 한국어와 영어를 모두 지원합니다. 브리핑 리포트도 한국어로 생성 가능합니다.",

  "landing.demo.title": "데모 로그인",
  "landing.demo.id": "아이디",
  ...
  "landing.hero.downloadDesktop": "데스크톱 앱 다운로드",

  "landing.whyMaker.title": "왜 Maker인가요?",
  "landing.whyMaker.subtitle": "기존 리서치 도구와 다른 Maker만의 강점입니다.",
  "landing.whyMaker.dataOwnership": "데이터 보안",
  "landing.whyMaker.dataOwnershipDesc": "기업 데이터가 외부로 유출되지 않습니다. 로컬 모드에서는 모든 데이터가 사내 서버에만 저장됩니다.",
  "landing.whyMaker.swapAI": "GPT-4o 기반 분석",
  "landing.whyMaker.swapAIDesc": "OpenAI의 최신 GPT-4o 모델이 수집된 정보를 분석합니다. 단순 요약이 아닌 실행 가능한 인사이트를 제공합니다.",
  "landing.whyMaker.worksOffline": "자동화된 일상",
  "landing.whyMaker.worksOfflineDesc": "한 번 설정하면 매일 자동으로 정보를 수집·분석·배송합니다. 수동 리서치에 쓰던 시간을 절약하세요.",
  "landing.whyMaker.humanControl": "사람이 통제",
  "landing.whyMaker.humanControlDesc": "AI가 어떤 정보를 수집하고 분석하는지 모든 과정이 투명합니다. 원치 않는 정보 수집은 없습니다.",

  "landing.sampleReport.executiveSummary": "핵심 요약",
  "landing.sampleReport.title": "이런 브리핑을 매일 받습니다",
  "landing.sampleReport.subtitle": "GPT-4o가 생성하는 실제 브리핑 예시입니다.",
  "landing.sampleReport.market.title": "Daily Market Brief | 2025.02.18",
  "landing.sampleReport.market.badge": "금융",
  "landing.sampleReport.market.summary": "연준 금리 동결 시사로 완화 사이클 불확실성 확대. 테크 실적 호조가 섹터 로테이션 유발. OPEC+ 감산 후 유가 안정 — 에너지 섹터 전망 개선.",
  "landing.sampleReport.market.item1": "연준 금리 동결 시사 — 채권 수익률 축소 가능, 테크/바이오텍 성장주 밸류에이션에 영향 전망",
  "landing.sampleReport.market.item2": "테크 실적 예상 상회, 나스닥 +2.3% — 거시 역풍에도 기업 IT 지출 지속 시사",
  "landing.sampleReport.market.item3": "OPEC+ 감산으로 유가 안정 — 에너지 섹터 재평가 가능, 제조업 하류 비용 압박 모니터링 필요",
  "landing.sampleReport.market.outlook": "주시: 차기 CPI 발표, ECB 금리 결정, 반도체 공급망 시그널",
  ...
  "landing.sampleReport.research.summary": "학습 비용 혁신이 기업 AI 도입 가속화 가능. 멀티모달 추론 급진전. 오픈소스 모델이 상업적 수준 도달.",
  "landing.sampleReport.research.item1": "새 트랜스포머 아키텍처, 학습 비용 40% 절감 — 중견기업의 커스텀 모델 배포 진입장벽 하락",
  "landing.sampleReport.research.item2": "멀티모달 추론 벤치마크 급진전 — 문서 처리 기업 응용이 상업적 실행 가능 단계 진입",
  "landing.sampleReport.research.item3": "오픈소스 LLM, 코딩에서 GPT-4 수준 달성 — 상용 API 가격에 경쟁 압박 예상",
  "landing.sampleReport.research.outlook": "모니터링: 프로덕션 배포 지표, 기업 도입률, 오픈소스 AI 규제 동향",
  ...
  "landing.sampleReport.promotion.badge": "마케팅",
  "landing.sampleReport.promotion.summary": "고관련성 게시 기회 3건 발견. r/SideProject에서 강한 수요 시그널. Indie Hackers \"Show\" 포맷 금주 트렌딩.",
  "landing.sampleReport.promotion.item1": "r/SideProject: 자동화 도구 찾는 글 3건 — 가치 중심 접근의 댓글 초안 검토 준비 완료",
  "landing.sampleReport.promotion.item2": "Indie Hackers: \"Show IH\" 포맷 금주 인게이지먼트 2배 — 추천 제목과 스토리 구성 준비됨",
  "landing.sampleReport.promotion.item3": "Hacker News: 워크플로우 도구 \"Ask HN\" 스레드 활성 — 커뮤니티 기대에 맞춘 기술 토킹 포인트 준비",
  "landing.sampleReport.promotion.outlook": "최적 타이밍: Reddit 화~수 오전 9-11시(EST), HN 평일 오전. 주말 게시 지양.",
  "landing.sampleReport.promotion.sources": "Reddit, Hacker News, Indie Hackers, Product Hunt",
  "landing.sampleReport.daily": "매일 아침 자동 생성 · 슬랙·이메일로 배송",

  "landing.openSource.title": "오픈 소스 기반",
  "landing.openSource.desc": "Maker의 핵심 엔진은 오픈소스입니다. 코드를 직접 확인하고, 온프레미스 설치도 가능합니다.",
  ...
  "botDetail.format.professional": "프로페셔널 (상급자 보고용, 분석 중심)",
  ...
  "botDetail.format.professional2": "프로페셔널",
  ...
  "guide.step2.subtitle": "OpenAI GPT-4o",
  ...
  "guide.step2.fieldNameEx": "예: 내 OpenAI API",
  "guide.step2.fieldType": "프로바이더 유형:",
  "guide.step2.fieldTypeEx": "OpenAI (GPT-4o) 선택",
  ...
  "guide.step2.fieldModelEx": "비워두거나 예: gpt-4o",
  ...
  "guide.faq.q4": "여러 AI 모델을 동시에 사용할 수 있나요?",
  ...
  "guide.desktop.title": "데스크톱 앱 설치 가이드",
  "guide.desktop.intro": "Maker 데스크톱 앱을 다운로드하여 로컬에서 사용할 수 있습니다. 플랫폼별 설치 방법을 안내합니다.",
  "guide.desktop.mac.title": "macOS 설치",
  "guide.desktop.mac.step1": "GitHub Releases 페이지에서 <strong>Maker-x.x.x-arm64.dmg</strong> 파일을 다운로드합니다.",
  "guide.desktop.mac.step2": "DMG 파일을 열고, Maker 아이콘을 Applications 폴더로 드래그합니다.",
  "guide.desktop.mac.step3": "처음 실행 시 <strong>\"Maker은(는) 열지 못함\"</strong> 경고가 나타날 수 있습니다.",
  "guide.desktop.mac.gatekeeper": "macOS 보안 경고 해결 방법",
  "guide.desktop.mac.gatekeeper.desc": "Apple은 코드 서명이 없는 앱의 실행을 차단합니다. 아래 방법으로 해제할 수 있습니다:",
  "guide.desktop.mac.method1.title": "방법 1: 시스템 설정에서 허용 (권장)",
  "guide.desktop.mac.method1.step1": "<strong>시스템 설정</strong> → <strong>개인정보 보호 및 보안</strong>으로 이동합니다.",
  "guide.desktop.mac.method1.step2": "아래쪽에 \"Maker\"이(가) 차단됨 메시지가 표시됩니다.",
  "guide.desktop.mac.method1.step3": "<strong>확인 없이 열기</strong> 버튼을 클릭합니다.",
  "guide.desktop.mac.method1.step4": "비밀번호를 입력하면 앱이 실행됩니다.",
  "guide.desktop.mac.method2.title": "방법 2: 우클릭으로 열기",
  "guide.desktop.mac.method2.step1": "Applications 폴더에서 Maker 앱을 <strong>Control + 클릭</strong> (또는 우클릭)합니다.",
  "guide.desktop.mac.method2.step2": "메뉴에서 <strong>열기</strong>를 선택합니다.",
  "guide.desktop.mac.method2.step3": "경고창에서 다시 <strong>열기</strong>를 클릭합니다.",
  "guide.desktop.mac.method3.title": "방법 3: 터미널 명령어 사용",
  "guide.desktop.mac.method3.step1": "터미널을 열고 아래 명령어를 실행합니다:",
  "guide.desktop.mac.method3.cmd": "xattr -cr /Applications/Maker.app",
  "guide.desktop.mac.method3.step2": "이후 정상적으로 앱을 실행할 수 있습니다.",
  "guide.desktop.windows.title": "Windows 설치",
  "guide.desktop.windows.step1": "GitHub Releases 페이지에서 <strong>Maker.Setup.x.x.x.exe</strong>를 다운로드합니다.",
  "guide.desktop.windows.step2": "설치 파일을 실행합니다. SmartScreen 경고가 나타나면 <strong>추가 정보</strong> → <strong>실행</strong>을 클릭합니다.",
  "guide.desktop.windows.step3": "설치가 완료되면 자동으로 앱이 실행됩니다.",
  "guide.desktop.linux.title": "Linux 설치",
  "guide.desktop.linux.step1": "GitHub Releases 페이지에서 <strong>Maker-x.x.x.AppImage</strong> 또는 <strong>.deb</strong> 파일을 다운로드합니다.",
  "guide.desktop.linux.step2": "AppImage: <code>chmod +x Maker-x.x.x.AppImage</code>로 실행 권한을 부여한 후 실행합니다.",
  "guide.desktop.linux.step3": "DEB: <code>sudo dpkg -i maker_x.x.x_amd64.deb</code>로 설치합니다.",
  "guide.desktop.download": "최신 버전 다운로드",
  ...
  "demo.hero.headline1": "AI가 당신의 시장을",
  "demo.hero.headline2": "1분 안에 분석합니다",
  "demo.hero.subheadline": "회사명만 입력하세요. GPT-4o가 경쟁사·시장·뉴스를 즉시 분석합니다.",
  "demo.hero.subheadlineBold": "Powered by OpenAI GPT-4o",
  "demo.hero.placeholder": "예: 삼성전자, 현대자동차, CJ제일제당",
  "demo.hero.analyzeButton": "무료 분석 시작",
  "demo.hero.analyzing": "분석 중...",
  "demo.hero.benefitFree": "무료 체험",
  ...
  "demo.progress.title": "분석 진행 중...",
  "demo.progress.progress": "진행률",
  "demo.progress.currentStep": "현재 단계",
  "demo.progress.elapsedTime": "경과 시간",
  "demo.progress.seconds": "초",
  "demo.progress.complete": "분석 완료!",
  "demo.progress.invalidAccess": "잘못된 접근입니다.",

  "demo.report.title": "AI 시장 분석 리포트",
  "demo.report.generatedAt": "생성일",
  "demo.report.analysisTime": "분석 소요 시간",
  "demo.report.secondsUnit": "초",
  "demo.report.loading": "리포트 로딩 중...",
  "demo.report.error": "리포트를 불러올 수 없습니다.",
  ...
  "demo.report.companyInfo.revenue": "매출",
  "demo.report.companyInfo.website": "웹사이트",
  "demo.report.summary": "요약",
  "demo.report.swot": "SWOT 분석",
  "demo.report.swot.strengths": "강점",
  "demo.report.swot.weaknesses": "약점",
  "demo.report.swot.opportunities": "기회",
  "demo.report.swot.threats": "위협",
  "demo.report.news": "최신 뉴스",
  "demo.report.news.positive": "긍정",
  "demo.report.news.neutral": "중립",
  "demo.report.news.negative": "부정",
  "demo.report.insights": "주요 인사이트",
  "demo.report.cta": "매일 이런 브리핑을 받아보세요",
  "demo.report.ctaDesc": "Maker에 가입하면 매일 아침 GPT-4o가 분석한 시장 브리핑을 슬랙·이메일로 받을 수 있습니다.",
  "demo.report.ctaButton": "무료 체험 시작",

  "structuredReport.companyOverview": "시장 개요",
  "structuredReport.industry": "산업",
  "structuredReport.keyPlayers": "주요 기업",
  "structuredReport.marketContext": "시장 상황",
  "structuredReport.executiveSummary": "핵심 요약",
  "structuredReport.swotAnalysis": "SWOT 분석",
  "structuredReport.swot.strengths": "강점",
  "structuredReport.swot.weaknesses": "약점",
  "structuredReport.swot.opportunities": "기회",
  "structuredReport.swot.threats": "위협",
  "structuredReport.latestNews": "최신 뉴스 및 감성 분석",
  "structuredReport.sentiment.positive": "긍정",
  "structuredReport.sentiment.neutral": "중립",
  "structuredReport.sentiment.negative": "부정",
  "structuredReport.keyInsights": "핵심 인사이트",

  "pd.group.autonomy": "자율성 & 에이전트",
  "pd.group.messaging": "메시징",

  "autonomy.title": "자율성 설정",
  "autonomy.subtitle": "봇의 자율 실행 수준을 설정합니다",
  "autonomy.level": "자율성 레벨",
  "autonomy.level.L0": "L0: 수동",
  "autonomy.level.L0.desc": "사용자가 직접 실행만 가능",
  "autonomy.level.L1": "L1: 제안",
  "autonomy.level.L1.desc": "계획을 세우고 승인 후 실행",
  "autonomy.level.L2": "L2: 승인 후 실행",
  "autonomy.level.L2.desc": "안전한 작업은 자동, 위험한 작업은 승인",
  "autonomy.level.L3": "L3: 정책 내 자동",
  "autonomy.level.L3.desc": "허용된 범위 내에서 완전 자동 (데스크톱 전용)",
  "autonomy.globalDefault": "전역 기본값",
  "autonomy.webMax": "웹 최대",
  "autonomy.desktopOnly": "데스크톱 전용",
  "autonomy.runLimits": "실행 제한",
  "autonomy.maxSteps": "최대 단계 수",
  "autonomy.maxRuntime": "최대 실행 시간",
  "autonomy.maxLLMCalls": "최대 LLM 호출 수",
  "autonomy.maxToolCalls": "최대 도구 호출 수",
  "autonomy.cooldown": "쿨다운",
  "autonomy.seconds": "초",

  "agent.title": "에이전트 실행",
  "agent.subtitle": "봇의 자율 실행 기록을 확인합니다",
  "agent.runAgent": "에이전트 실행",
  "agent.goalPlaceholder": "목표를 입력하세요 (예: RSS 수집 후 분석)",
  "agent.plan": "계획 생성",
  "agent.run": "실행하기",
  "agent.running": "실행 중...",
  "agent.noRuns": "아직 실행 기록이 없습니다",
  "agent.recentRuns": "최근 실행",
  "agent.status.success": "성공",
  "agent.status.error": "오류",
  "agent.status.timeout": "시간 초과",
  "agent.status.blocked": "차단됨",
  "agent.status.denied": "거부됨",
  "agent.status.running": "실행 중",
  "agent.steps": "단계",
  "agent.duration": "소요 시간",
  "agent.trigger.manual": "수동",
  "agent.trigger.schedule": "스케줄",
  "agent.trigger.telegram": "텔레그램",
  "agent.planApproval": "계획 승인",
  "agent.planApproval.desc": "다음 작업을 수행합니다. 승인하시겠습니까?",
  "agent.planApproval.permissions": "필요한 권한",
  "agent.planApproval.risk": "위험 요약",
  "agent.planApproval.high": "높음",
  "agent.planApproval.medium": "보통",
  "agent.planApproval.low": "낮음",
  "agent.planApproval.approve": "승인 및 실행",
  "agent.planApproval.cancel": "취소",
  "agent.stepDetail": "단계 상세",
  "agent.step.tool": "도구",
  "agent.step.permission": "권한",
  "agent.step.input": "입력",
  "agent.step.output": "출력",
  "agent.step.rationale": "이유",
  "agent.step.riskScore": "위험 점수",
  "agent.step.blocked": "정책 차단",
  "agent.step.egress": "데이터 전송됨",

  "risk.title": "위험 예산",
  "risk.budget": "예산",
  "risk.consumed": "사용",
  "risk.remaining": "남은 예산",
  "risk.usage": "사용률",
  "risk.score": "위험 점수",
  "risk.budgetExceeded": "위험 예산 초과로 종료됨",
  "risk.conservative": "보수적 (10)",
  "risk.balanced": "균형 (25)",
  "risk.advanced": "고급 (50)",
  "risk.custom": "사용자 지정",
  "risk.highestStep": "최고 위험 단계",
  "risk.blockedActions": "차단된 작업",

  "explain.title": "설명",
  "explain.why": "왜 이 계획인가?",
  "explain.policy": "적용된 정책",
  "explain.risk": "위험 영향",
  "explain.summary": "실행 요약",

  "termination.completed": "완료",
  "termination.timeout": "시간 초과",
  "termination.step_limit": "단계 제한",
  "termination.llm_limit": "LLM 호출 제한",
  "termination.tool_limit": "도구 호출 제한",
  "termination.cooldown_block": "쿨다운 차단",
  "termination.risk_limit_reached": "위험 예산 초과",
  "termination.policy_denied": "정책 거부",
  "termination.user_denied": "사용자 거부",
  "termination.plan_mismatch": "계획 불일치",

  "perm.RISK_BUDGET_LIMIT": "위험 예산 한도",
  "perm.CRITICAL_AUTO_ALLOW": "위험 단계 자동 실행",
  "perm.EXPLAINABILITY_REQUIRED": "설명 생성 필수",

  "about.nav.back": "돌아가기",
  "about.overview.tag": "Control-First AI Operating System",
  "about.overview.p1": "Maker는 AI를 더 강하게 만드는 회사가 아닙니다.",
  "about.overview.p2": "Maker는 AI를 통제 가능하게 만드는 회사입니다.",
  "about.overview.p3": "우리는 AI 자동화가 편리함을 넘어 운영 가능해야 한다고 믿습니다.",
  "about.overview.p4": "AI는 도구입니다. 판단과 책임은 인간에게 있어야 합니다.",
  "about.overview.p5": "Maker는 개인이 자신의 자동화 구조를 설계하고, 통제하고, 감사할 수 있도록 돕는 Control-First AI OS를 만듭니다.",

  "about.mission.title": "우리의 미션",
  "about.mission.quote": "인간이 통제할 수 있는 AI 운영체제를 만든다.",
  "about.mission.p1": "AI는 빠르게 발전하고 있습니다. 그러나 통제 구조는 그만큼 발전하지 않았습니다.",
  "about.mission.goal1": "AI 실행의 가시성",
  "about.mission.goal2": "정책 기반 통제",
  "about.mission.goal3": "리스크 예산 관리",
  "about.mission.goal4": "데이터 소유권 보장",
  "about.mission.goal5": "설명 가능한 자율성",
  "about.mission.closing": "AI가 강력해질수록 통제는 더 정교해져야 합니다.",

  "about.philosophy.title": "우리의 철학",
  "about.philosophy.subtitle1": "우리는 AI를 신뢰하지 않습니다.",
  "about.philosophy.subtitle2": "우리는 사용자의 통제권을 신뢰합니다.",
  "about.philosophy.p1.title": "Nothing Runs Silently",
  "about.philosophy.p1.desc": "모든 실행은 기록됩니다.",
  "about.philosophy.p2.title": "Autonomy Must Be Bounded",
  "about.philosophy.p2.desc": "자율성은 시간, 단계, 위험 예산 안에 있어야 합니다.",
  "about.philosophy.p3.title": "Data Belongs to the User",
  "about.philosophy.p3.desc": "데이터는 사용자에게 있습니다.",
  "about.philosophy.p4.title": "Policy Before Power",
  "about.philosophy.p4.desc": "권한은 기능보다 먼저 설계되어야 합니다.",
  "about.philosophy.p5.title": "Explanation Is Mandatory",
  "about.philosophy.p5.desc": "AI의 행동은 설명 가능해야 합니다.",
  "about.philosophy.p6.title": "Risk Must Be Measurable",
  "about.philosophy.p6.desc": "위험은 정량화되고 관리되어야 합니다.",
  "about.philosophy.p7.title": "Human Remains Accountable",
  "about.philosophy.p7.desc": "최종 책임은 항상 인간에게 있습니다.",

  "about.notUs.title": "Maker는 이것이 아닙니다",
  "about.notUs.item1": "무제한 자율 에이전트 플랫폼",
  "about.notUs.item2": "블랙박스 자동화 도구",
  "about.notUs.item3": "데이터 수집 중심 SaaS",
  "about.notUs.item4": "AI에게 전권을 위임하는 시스템",
  "about.notUs.closing": "우리는 통제 없는 자율성을 추구하지 않습니다.",

  "about.product.title": "Maker는 무엇인가?",
  "about.product.not1": "AI 자동화 툴이 아닙니다.",
  "about.product.not2": "단순한 에이전트 프레임워크도 아닙니다.",
  "about.product.not3": "뉴스레터 생성 서비스도 아닙니다.",
  "about.product.quote": "개인을 위한 AI 실행 커널입니다.",
  "about.product.rule1": "정책을 통과해야 하고",
  "about.product.rule2": "리스크 예산 안에 있어야 하며",
  "about.product.rule3": "로그로 남고",
  "about.product.rule4": "설명되어야 합니다.",

  "about.whyNow.title": "왜 지금인가",
  "about.whyNow.p1": "AI는 빠르게 대중화되고 있습니다.",
  "about.whyNow.q1": "누가 통제하는가?",
  "about.whyNow.q2": "어떤 기준으로 실행되는가?",
  "about.whyNow.q3": "어떤 데이터가 외부로 나가는가?",
  "about.whyNow.q4": "실패했을 때 책임은 누구에게 있는가?",
  "about.whyNow.closing": "Maker는 이 질문에서 출발했습니다.",

  "about.vision.title": "장기 비전",
  "about.vision.p1": "우리는 단순한 앱을 만들지 않습니다.",
  "about.vision.quote": "AI 시대의 통제 가능한 운영체제",
  "about.vision.phase1": "1단계: 개인용 Maker OS",
  "about.vision.phase2": "2단계: 분산 실행 + 로컬 통제",
  "about.vision.phase3": "3단계: 조직 단위 거버넌스",
  "about.vision.closing": "그러나 언제나 출발점은 같습니다. 개인의 통제권.",

  "about.founder.title": "창업자 노트",
  "about.founder.p1": "Maker는 두려움에서 출발하지 않았습니다. 그러나 무비판적 낙관에서도 출발하지 않았습니다.",
  "about.founder.p2": "AI는 강력합니다. 그렇기 때문에 통제 구조가 필요합니다.",
  "about.founder.p3": "Maker는 AI를 더 강하게 만드는 프로젝트가 아니라 AI를 안전하게 사용할 수 있도록 만드는 시도입니다.",

  "about.taglines.t1": "AI를 통제 가능한 시스템으로 만드는 OS",
  "about.taglines.t2": "Control-First AI Operating System",
  "about.taglines.t3": "Governable Autonomy Platform",
  "about.taglines.t4": "AI 실행을 정책과 리스크 안에 두는 시스템",

  "about.investor": "Maker는 'Autonomous AI'를 'Governable AI'로 전환하는 실행 인프라입니다.",
};
