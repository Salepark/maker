export const ko: Record<string, string> = {
  ...
  "landing.hero.oneLiner": "RSS 수집 → AI 분석 → 리포트 자동 생성. 매일 아침 나만의 브리핑.",
  "landing.hero.stat1": "16+ 템플릿",
  "landing.hero.stat2": "5분 만에 시작",
  "landing.hero.stat3": "100% 내 데이터",
  "landing.hero.downloadDesktop": "데스크톱 다운로드",

  "landing.whyMaker.title": "왜 Maker인가?",
  "landing.whyMaker.subtitle": "또 하나의 SaaS가 아닙니다. Maker는 당신이 통제권을 갖도록 설계되었습니다.",
