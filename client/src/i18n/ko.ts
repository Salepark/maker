export const ko: Record<string, string> = {
  ...
  "landing.sampleReport.promotion.title": "홍보 전략 브리핑",
  "landing.sampleReport.promotion.badge": "마케팅",
  "landing.sampleReport.promotion.item1": "r/SideProject: 당신과 비슷한 도구를 찾는 글 3개 — 댓글 초안 준비됨",
  "landing.sampleReport.promotion.item2": "Indie Hackers: \"Show IH\" 포맷 인기 상승 중, 추천 제목 포함",
  "landing.sampleReport.promotion.item3": "Hacker News: 자동화 도구 \"Ask HN\" 스레드 — 토킹 포인트 준비됨",
  "landing.sampleReport.promotion.trend": "최적 타이밍: Reddit은 화/수 오전 9-11시(EST), HN은 평일 오전",
