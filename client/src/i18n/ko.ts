export const ko: Record<string, string> = {
  ...
  "landing.useCase.websitePromotion": "웹사이트 & 서비스 홍보",
  "landing.useCase.websitePromotionDesc": "타겟 오디언스가 모이는 커뮤니티를 모니터링하고, 어디에 어떤 글을 올리면 좋은지 매일 제안합니다. 커뮤니티 톤에 맞는 제목과 포인트 초안까지 제공. 검토 후 직접 게시하세요.",
  ...
  "landing.sampleReport.subtitle": "매일 자동 생성되는 프로페셔널 비즈니스 리포트 — 상급자에게 바로 보고 가능한 품질.",
  ...
  "demo.hero.analyzeButton": "무료로 분석하기",
  ...
  "demo.report.cta": "더 깊은 실시간 분석이 필요하신가요?",
  "demo.report.ctaDesc": "Maker에 가입하면 매일 AI 기반 경쟁사 모니터링 리포트를 자동으로 받아보실 수 있습니다.",
  "demo.report.ctaButton": "무료로 시작하기",
