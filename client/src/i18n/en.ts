export const en: Record<string, string> = {
  ...
  "landing.pricing.desktop.name": "Desktop",
  "landing.pricing.desktop.price": "Free",
  "landing.pricing.desktop.desc": "Self-hosted automation on your local machine",
  "landing.pricing.desktop.f1": "Works offline",
  "landing.pricing.desktop.f2": "100% local data storage",
  "landing.pricing.desktop.f3": "Mac · Windows · Linux",
  "landing.pricing.desktop.f4": "Open source (GitHub)",
  "landing.pricing.desktop.button": "Download",
  ...
  "about.nav.back": "Back",
  "about.overview.tag": "Control-First AI Operating System",
  "about.overview.p1": "Maker is not a company that makes AI stronger.",
  "about.overview.p2": "Maker is a company that makes AI controllable.",
  "about.overview.p3": "We believe AI automation must go beyond convenience — it must be operable.",
  "about.overview.p4": "AI is a tool. Judgment and responsibility must remain with humans.",
  "about.overview.p5": "Maker builds a Control-First AI OS that helps individuals design, control, and audit their own automation systems.",

  "about.mission.title": "Our Mission",
  "about.mission.quote": "Build an AI operating system that humans can control.",
  "about.mission.p1": "AI is advancing rapidly. But control structures have not kept pace.",
  "about.mission.goal1": "Visibility into AI execution",
  "about.mission.goal2": "Policy-based control",
  "about.mission.goal3": "Risk budget management",
  "about.mission.goal4": "Data ownership guarantee",
  "about.mission.goal5": "Explainable autonomy",
  "about.mission.closing": "As AI grows more powerful, control must grow more sophisticated.",

  "about.philosophy.title": "Our Philosophy",
  "about.philosophy.subtitle1": "We don't trust AI.",
  "about.philosophy.subtitle2": "We trust the user's right to control it.",
  "about.philosophy.p1.title": "Nothing Runs Silently",
  "about.philosophy.p1.desc": "Every execution is logged.",
  "about.philosophy.p2.title": "Autonomy Must Be Bounded",
  "about.philosophy.p2.desc": "Autonomy must exist within time, steps, and risk budgets.",
  "about.philosophy.p3.title": "Data Belongs to the User",
  "about.philosophy.p3.desc": "Your data stays with you.",
  "about.philosophy.p4.title": "Policy Before Power",
  "about.philosophy.p4.desc": "Permissions must be designed before capabilities.",
  "about.philosophy.p5.title": "Explanation Is Mandatory",
  "about.philosophy.p5.desc": "AI actions must be explainable.",
  "about.philosophy.p6.title": "Risk Must Be Measurable",
  "about.philosophy.p6.desc": "Risk must be quantified and managed.",
  "about.philosophy.p7.title": "Human Remains Accountable",
  "about.philosophy.p7.desc": "Final responsibility always lies with humans.",

  "about.notUs.title": "What We Are Not",
  "about.notUs.item1": "An unlimited autonomous agent platform",
  "about.notUs.item2": "A black-box automation tool",
  "about.notUs.item3": "A data-collection-centric SaaS",
  "about.notUs.item4": "A system that delegates full authority to AI",
  "about.notUs.closing": "We do not pursue autonomy without control.",

  "about.product.title": "What Is Maker?",
  "about.product.not1": "It's not an AI automation tool.",
  "about.product.not2": "It's not a simple agent framework.",
  "about.product.not3": "It's not a newsletter generation service.",
  "about.product.quote": "Maker is a personal AI execution kernel.",
  "about.product.rule1": "Must pass through policies",
  "about.product.rule2": "Must stay within the risk budget",
  "about.product.rule3": "Must be logged",
  "about.product.rule4": "Must be explained",

  "about.whyNow.title": "Why Now",
  "about.whyNow.p1": "AI is rapidly becoming mainstream.",
  "about.whyNow.q1": "Who controls it?",
  "about.whyNow.q2": "By what criteria is it executed?",
  "about.whyNow.q3": "What data is leaving the system?",
  "about.whyNow.q4": "When it fails, who is responsible?",
  "about.whyNow.closing": "Maker started from these questions.",

  "about.vision.title": "Our Long-Term Vision",
  "about.vision.p1": "We are not just building an app.",
  "about.vision.quote": "A controllable operating system for the AI era.",
  "about.vision.phase1": "Phase 1: Personal Maker OS",
  "about.vision.phase2": "Phase 2: Distributed execution + local control",
  "about.vision.phase3": "Phase 3: Organization-level governance",
  "about.vision.closing": "But the starting point is always the same — individual control.",

  "about.founder.title": "Founder's Note",
  "about.founder.p1": "Maker did not start from fear. But it did not start from uncritical optimism either.",
  "about.founder.p2": "AI is powerful. That is precisely why control structures are necessary.",
  "about.founder.p3": "Maker is not a project to make AI stronger — it is an effort to make AI safe to use.",

  "about.taglines.t1": "An OS that makes AI controllable",
  "about.taglines.t2": "Control-First AI Operating System",
  "about.taglines.t3": "Governable Autonomy Platform",
  "about.taglines.t4": "A system that puts AI execution within policy and risk",

  "about.investor": "Maker is the execution infrastructure that transforms 'Autonomous AI' into 'Governable AI'.",
};
