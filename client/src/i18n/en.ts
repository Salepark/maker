export const en: Record<string, string> = {
  ...
  "landing.hero.title1": "Build Safe Automation,",
  "landing.hero.title2": "Your Way",
  "landing.hero.subtitle": "AI runs only when you approve. Choose your sources, set your schedule, and design your outputs — with every action logged and every permission explicit.",
  ...
  "landing.hero.badge3": "Approval-based AI execution",
  ...
  "landing.hero.aiAnalysis": "Safe AI Analysis",
  "landing.hero.aiAnalysisDesc": "AI analyzes content only with your approval. Every run is logged and auditable.",
  ...
  "landing.howItWorks.step3Title": "Safe Automated Operations",
  "landing.howItWorks.step3Desc": "Your bot runs within the boundaries you set. Every execution is logged, every AI call requires approval. Control and audit anytime via the console.",
  ...
  "landing.useCase.websitePromotion": "Website & Service Promotion",
  "landing.useCase.websitePromotionDesc": "Monitor communities where your audience gathers, then get daily suggestions on where to post and what to write — with draft titles and talking points. You review and post yourself.",
  ...
  "landing.whyMaker.title": "Safe by Design",
  "landing.whyMaker.subtitle": "Built on 7 core principles. AI never runs behind your back. Every action is transparent, every permission is explicit.",
  "landing.whyMaker.dataOwnership": "Your Data Stays Yours",
  "landing.whyMaker.dataOwnershipDesc": "Local-first architecture. Your data never leaves without your permission. Run entirely offline with the desktop version.",
  "landing.whyMaker.swapAI": "Swap Any AI, Anytime",
  "landing.whyMaker.swapAIDesc": "Not locked into one AI provider. Use OpenAI, Anthropic, Google, or any compatible API. Switch freely as models improve.",
  "landing.whyMaker.worksOffline": "Works Offline Too",
  "landing.whyMaker.worksOfflineDesc": "Download the desktop app and run everything locally with SQLite. No internet required for your automation engine.",
  "landing.whyMaker.humanControl": "You Stay in Control",
  "landing.whyMaker.humanControlDesc": "AI never runs without your approval. Every action is logged, every permission is explicit. Automation assists — it doesn't replace you.",

  "landing.sampleReport.executiveSummary": "Executive Summary",
  "landing.sampleReport.title": "See What You Get",
  "landing.sampleReport.subtitle": "Professional business reports generated daily — ready for executive review.",
  ...
  "landing.sampleReport.daily": "Generated daily at 7:00 AM",

  "landing.openSource.title": "Open Source & Transparent",
  "landing.openSource.desc": "Core engine is AGPL-3.0. Inspect, modify, and self-host. No black boxes.",
  ...
  "demo.report.title": "Competitor Analysis Report",
  ...
  "demo.report.cta": "Want deeper, real-time analysis?",
  "demo.report.ctaDesc": "Sign up for Maker to set up automated competitor monitoring with daily AI-powered reports.",
  "demo.report.ctaButton": "Get Started for Free",
