export const en: Record<string, string> = {
  ...
  "landing.hero.oneLiner": "RSS feeds in, AI-analyzed reports out. Your morning briefing, automated.",
  "landing.hero.stat1": "16+ Templates",
  "landing.hero.stat2": "5 min setup",
  "landing.hero.stat3": "100% your data",
  "landing.hero.downloadDesktop": "Download Desktop",

  "landing.whyMaker.title": "Why Maker?",
  "landing.whyMaker.subtitle": "Not just another SaaS. Maker is built on principles that put you in control.",
