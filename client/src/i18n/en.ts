export const en: Record<string, string> = {
  ...
  "landing.sampleReport.subtitle": "Real examples of daily reports Maker generates automatically.",
  "landing.sampleReport.market.title": "Daily Market Brief",
  "landing.sampleReport.market.badge": "Finance",
  "landing.sampleReport.market.item1": "Fed signals rate pause amid mixed economic data",
  "landing.sampleReport.market.item2": "Tech earnings beat expectations, NASDAQ up 2.3%",
  "landing.sampleReport.market.item3": "Oil prices stabilize after OPEC+ production cuts",
  "landing.sampleReport.market.trend": "Trending: AI stocks, semiconductor shortage, green energy policy",
  "landing.sampleReport.market.sources": "Reuters, Yahoo Finance, Reddit r/investing",
  "landing.sampleReport.research.title": "AI Research Digest",
  "landing.sampleReport.research.badge": "Research",
  "landing.sampleReport.research.item1": "New transformer architecture reduces training cost by 40%",
  "landing.sampleReport.research.item2": "Multimodal reasoning benchmark shows rapid progress",
  "landing.sampleReport.research.item3": "Open-source LLM achieves GPT-4 level on coding tasks",
  "landing.sampleReport.research.trend": "Trending: efficient training, multimodal AI, open-source models",
  "landing.sampleReport.research.sources": "ArXiv, Google AI Blog, Hacker News",
  "landing.sampleReport.promotion.title": "Promotion Strategy Brief",
  "landing.sampleReport.promotion.badge": "Marketing",
  "landing.sampleReport.promotion.item1": "r/SideProject: 3 threads asking for tools like yours — draft comment ready",
  "landing.sampleReport.promotion.item2": "Indie Hackers: \"Show IH\" post format trending, suggested title included",
  "landing.sampleReport.promotion.item3": "Hacker News: \"Ask HN\" thread on automation tools — talking points prepared",
  "landing.sampleReport.promotion.trend": "Best timing: Tue/Wed 9-11 AM EST for Reddit, weekday mornings for HN",
